...
permission:
  bash:
    # Catch-all deny (last matching rule wins — broad rules first)
    "*": "ask"
    # All read-only inspection
    "ls *": "allow"
    "ls": "allow"
    "cat *": "allow"
    "head *": "allow"
    ...
    # Git read-only (all variants: direct, -C, --git-dir)
    "git *status*": "allow"
    "git *log*": "allow"
    "git *diff*": "allow"
    "git *show*": "allow"
    ...
    "cp *": "deny"
    "dd *": "deny"
    # .env protection (LAST — overrides cat/grep/head/tail above)
    "cat .env*": "deny"
    "cat */.env*": "deny"
    "head .env*": "deny"
    "head */.env*": "deny"
